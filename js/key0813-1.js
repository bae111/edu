...
//img-01 누르면 이미지 바뀌고 라운드 조금 각지게
//img-02 누르면 이미지 바뀌고 라운드 동그랗게
//url 사용 시 주소는 "" 안에 적어야 함

$(function(){
    $('#stopBtn').on('click',function(){
        $('.any-02').css({'backgroundImage' : 'url("../img/key01.jpg")' , 'border-radius' : '30%'});
    });
    $('#startBtn').on('click',function(){
        $('.any-02').css({'backgroundImage' : 'url("../img/key02.jpg")' , 'border-radius' : '50%'});
    });
});